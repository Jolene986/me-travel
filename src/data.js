...
export default [
  {
    ...
    fields: {
      name: 'Citadel',
      slug: 'citadel',
      'Galactic Regions': 'Outer Council Space',
      price: 1000,
      'radius/length': 44.7,
      'party members': 2,
      pets: true,
      tradicional_food: false,
      featured: true,
      description:
  ...
  },
  {
    ...
    fields: {
      name: 'Omega',
      slug: 'omega',
      'Galactic Regions': 'Terminus Systems',
      price: 1500,
      'radius/length': 44.7,
      'party members': 1,
      pets: false,
  ...
  },
  {
    ...
    fields: {
      name: 'Virmire',
      slug: 'virmire',
      'Galactic Regions': 'Attican Traverse',
      price: 2500,
      'radius/length': 6440,
      'party members': 1,
      pets: false,
  ...
  },
  {
    ...
    fields: {
      name: 'Eden Prime',
      slug: 'eden-prime',
      'Galactic Regions': 'Earth Systems Alliance Space',
      price: 3000,
      'radius/length': 7026,
      'party members': 1,
      pets: true,
      tradicional_food: true,
      featured: false,
      description:
  ...
  },
  {
    ...
    fields: {
      name: 'Irune',
      slug: 'irune',
      'Galactic Regions': 'Inner Council Space',
      price: 2500,
      'radius/length': 11525,
      'party members': 2,
      pets: false,
  ...
  },
  {
    ...
    fields: {
      ...
      'travel advisory': 'The Geth ARE FRENDLY! Do Not Open Fire!',
      extras: [
        'Visit the Normandy Crash Site',
        'Deep dive with Leviathan',
        'watch Shepherds head cam footage of the suicide mission in HD',
